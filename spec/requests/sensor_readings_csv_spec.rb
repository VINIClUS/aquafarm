...
RSpec.describe "SensorReadings CSV", type: :request do
  ...
  let!(:r1) { create(:sensor_reading, pond: pond, reading_time: Time.zone.parse("2025-09-05 10:00")) }
  let!(:r2) { create(:sensor_reading, pond: pond, reading_time: Time.zone.parse("2025-09-05 12:00")) }
